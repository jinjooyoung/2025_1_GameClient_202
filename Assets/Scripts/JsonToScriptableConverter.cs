...
public class JsonToScriptableConverter : EditorWindow
{
    ...
    private string outputFolder = "Assets/ScriptableObjects/items"; // 출력 SO 파일을 저장할 경로 값
    ...
    private void ConverterJsonToScriptableObjects()     // JSON 파일을 ScriptableObject 파일로 변환시켜주는 함수
    {
        // 폴더 생성
